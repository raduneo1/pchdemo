        ...
        return (
		  ...
		  <div className="ui-g">
		    <div className="ui-g-12 ui-md-8 ui-lg-6">
			    <Switch>
			      <Route exact path='/' render={()=><Search imgBaseUrl={this.state.imgBaseUrl}/>}/>
			      <Route exact path='/reviews' render={()=><Reviews reviews={this.state.reviews} imgBaseUrl={this.state.imgBaseUrl}/>}/>
			      <Route exact path='/movies' render={()=><MyMovies imgBaseUrl={this.state.imgBaseUrl}/>}/>
			    </Switch>
		     </div>
		   </div>
